...
namespace WebApplication1.Controllers
{
    public class ThongKeLuongController : Controller
    {
            ...
            try
            {
                if (MaPB == "12")
                {
                    ...
                    else
                    {
                        ...
                        luongThangs = db.LuongThangs.OrderBy(x => x.LuongCoBan.NhanVien.HoTen).OrderBy(x => x.ThangNam);
                        return View(luongThangs.ToList().ToPagedList(pageNumber, pageSize));
                    }
                }
                else if (MaPB != null)
            ...
            try
            {
                if (loaiTimKiem == "MaNhanVien")
                {
                    if (year != null && month != null)
                    {
                        ...
                        {
                            this.AddNotification("Tháng: " + month + ", năm: " + year + ", tìm kiếm theo: " + loaiTimKiem + ", từ khóa tìm kiếm: " + tenTimKiem, NotificationType.INFO);
                        }
                    ...
                    else if (year != null && month == null)
                    {
                        ...
                        {
                            this.AddNotification("Năm: " + year + ", tìm kiếm theo: " + loaiTimKiem + ", từ khóa tìm kiếm: " + tenTimKiem, NotificationType.INFO);
                        }
                    ...
                    else if (year == null && month != null)
                    {
                        ...
                        {
                            this.AddNotification("Tháng: " + month + ", tìm kiếm theo: " + loaiTimKiem + ", từ khóa tìm kiếm: " + tenTimKiem, NotificationType.INFO);
                        }
                ...
                else
                {
                    ...
                    {
                        TruyenPara2(month, year, loaiTimKiem, tenTimKiem);
                        this.AddNotification("Tháng: " + month + ", năm: " + year, NotificationType.INFO);
                        luongThangs = db.LuongThangs.Where(x => x.ThangNam.Year == year && x.ThangNam.Month == month).OrderBy(x => x.LuongCoBan.NhanVien.HoTen);
                        return View(luongThangs.ToList().ToPagedList(pageNumber, pageSize));
                    }
                    else if (year != null && month == null)
                    {
                        TruyenPara2(month, year, loaiTimKiem, tenTimKiem);
                        this.AddNotification("Năm: " + year, NotificationType.INFO);
                        luongThangs = db.LuongThangs.Where(x => x.ThangNam.Year == year).OrderBy(x => x.LuongCoBan.NhanVien.HoTen);
                        return View(luongThangs.ToList().ToPagedList(pageNumber, pageSize));
                    }
                    else if (year == null && month != null)
                    {
                        TruyenPara2(month, year, loaiTimKiem, tenTimKiem);
                        this.AddNotification("Tháng: " + month, NotificationType.INFO);
                        luongThangs = db.LuongThangs.Where(x => x.ThangNam.Month == month).OrderBy(x => x.LuongCoBan.NhanVien.HoTen);
                        return View(luongThangs.ToList().ToPagedList(pageNumber, pageSize));
                    }
                    else
        ...
        #region In ra danh sách lương tháng của phòng ban
        ...
        #region In ra danh sách lương tháng theo nhân viên
